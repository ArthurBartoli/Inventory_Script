def scan_export(json_data):
    ...
    for t in range(len(json_data)):
        ...
        is_personal_workspace = ("PersonalWorkspace" in workspaceName or "My workspace" in workspaceName)
        type_espace = "PersonalWorkspace" if is_personal_workspace else "SharedWorkspace"
